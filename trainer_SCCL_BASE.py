...
def get_misclassified_indices(pred_labels, class_labels):
    ...
    for b in range(B):
        ...
        mis_idx_list.append(linear_idx)  # List[Tensor]
    return mis_idx_list
...
class SCCL(nn.Module):
    def __init__(self, temperature=0.1, num_positives=10, num_negatives=10, sample_ratio=0.25, ignore_class=0):
        super().__init__()
